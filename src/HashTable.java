...
public class HashTable<E>
{
     ...
     * @param valueToStore the item to insert.
     */
    public boolean insert( E hashKey, E valueToStore )
    {
        // Insert x as active
        int currentPos = findPos( hashKey );
        if( isActive( currentPos ) )
            return false;

        array[ currentPos ] = new HashEntry<>( hashKey, valueToStore, true );
    ...
    private void rehash( )
    {
        ...
        for( HashEntry<E> entry : oldArray )
            if( entry != null && entry.isActive )
                insert( entry.element , entry.elementValue );
    }
    ...
    public E find( E x )
    {
        ...
        if (!isActive( currentPos )) {
            ...
            return array[currentPos].elementValue;
        }
    }
    ...
    private static class HashEntry<E>
    {
        ...
        public HashEntry( E e, E val, boolean i )
        {
            element  = e;
            elementValue = val;
            isActive = i;
